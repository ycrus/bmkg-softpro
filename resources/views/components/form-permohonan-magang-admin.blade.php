<div class="relative text-gray-900 bg-white shadow-sm dark:text-gray-100 dark:bg-gray-800 h-max lg:sticky lg:top-12">
    ...
    <form
        action="{{ $is_edit ? route('admin.permohonan-magang.update', ['permohonan_magang' => $permohonan]) : route('admin.permohonan-magang.store') }}"
            ...
            @if ($is_edit)
                <div>
                    ...
                    <select name="status" id="status"
                        ...
                        @php
                            $status = ['Menunggu','Diterima', 'Ditolak', 'Sedang Magang', 'Selesai'];
                        @endphp
